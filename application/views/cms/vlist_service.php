 ...
 */
    ...
    $list->sql_key = "ser_id";
    $list->sql_select = "ser_id, ser_title, ser_website, ser_contact_nr, ser_email, ser_type";
    ...
    $list->add_field("Service Type", "ser_type", ["function" => function($ser_type){ return Lib_db::get_enum_value("service", "ser_type", $ser_type); }]);
